...
if [ -d ../../DataSummary/test1071 ]; then
    ...
    ../SCFenergy test1071.mat >> ../outfile 2>&1
else
...
if [ -d ../../DataSummary/test1129 ]; then
    ...
    ../SCFenergy test1129.dat >> ../outfile 2>&1
else
...
if [ -d ../../DataSummary/test1132 ]; then
    ...
    ../SCFenergy test1132.mat >> ../outfile 2>&1
else
...
echo "------------------------------------------------------------------" >> ../outfile 2>&1
../SCFenergy test1132.mat test1132gr.dat test1132r.dat test1132u.dat ${GauBINARY} >> ../outfile 2>&1
cd ..
rm -r test1132
